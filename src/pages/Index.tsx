  ...
  return <div className="min-h-screen flex flex-col">
    ...
    <section className="bg-gradient-to-b from-guardian-soft-green to-white py-24 px-4">
      <div className="container mx-auto text-center">
        ...
        <p className="text-xl md:text-2xl text-gray-700 mb-8 max-w-3xl mx-auto">專為仁愛基金會打造的數位助手，支援長期服務對象追蹤與智慧分析</p>
      ...
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-guardian-soft-blue rounded-lg p-6">
            ...
            <h3 className="text-xl font-bold mb-2">服務對象管理</h3>
            <p className="text-gray-700">完整的服務對象資料庫，支援時間軸追蹤與歷史記錄查詢</p>
          </div>
          ...
          <div className="bg-guardian-soft-purple rounded-lg p-6">
            ...
            <p className="text-gray-700">使用AI技術分析服務對象資料，生成摘要報告與發展趨勢</p>
          </div>
    ...
    <section className="bg-guardian-green py-16 px-4">
      <div className="container mx-auto text-center">
        ...
        <p className="text-xl text-white mb-8 max-w-2xl mx-auto">為仁愛基金會導入數位化管理服務對象資料工具，提升工作效率與服務質量</p>
    ...
    <footer className="bg-gray-100 py-8 px-4">
      <div className="container mx-auto text-center">
        <p className="text-gray-600">© 2025 守護樹 - 服務對象資料整合與洞察系統</p>
      </div>
    </footer>
  </div>;
};
